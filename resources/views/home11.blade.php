    ...
    <header id="header" class="full-header">
        <div id="header-wrap">
            <div class="container clearfix">
              <div id="logo">
         <a href="index.html" class="standard-logo" data-dark-logo="logo.png"><img src="logo.png" alt="Allour Travel Logo"></a>
        <a href="index.html" class="retina-logo" data-dark-logo="logo-dark@2x.png"><img src="logo@2x.png" alt="Allour Travel Logo"></a>
    </div>
    </div>
</header>
            ...
            <div class="container clearfix">
                <div class="postcontent">
                    ...
                    <div class= "countdown mb-1" id="countdown" >
                        ...
                        <button type="submit" class="btn btn-primary">Add to My Calender</button>
                    </div>
...
{{--                                <input type="text" class="form-control" id="inputEmail4" name="middle_name" placeholder="Middle Name" required>--}}
{{--                            </div>--}}
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control" id="inputEmail4" name="passport_num" placeholder="Passport Number" required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <!-- <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputState">Flags</label>
                            <select id="from_cities" name="from_cities" class="form-control" required>
                              <option value=""> Choose a flag </option>
                              <option value="city">Riyadh</option>
                              <option value="city">Riyadh</option>
                              <option value="city">Riyadh</option>
                              <option value="city">Riyadh</option>
                              <option value="city">Riyadh</option>
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <select id="from_cities" name="from_cities" class="form-control" required>
                                ...
                                <option value="city">Small</option>
                                <option value="city">Medium</option>
                                <option value="city">Large</option>
                                <option value="city">XLarge</option>
                                <option value="city">XXLarge</option>
                                <option value="city">XXXLarge</option>
                              </select>
                            </div>
                        </div> -->
                        <div class="form-row">
                            <div class="form-group  col-md-6">
                                ...
                                <input type="file" class="form-control" id="passport" name="passport" placeholder="Passport Copy Attachment" >
                            </div>
                        </div>
