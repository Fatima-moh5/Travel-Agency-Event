...
<div id="wrapper" class="clearfix">
    ...
    <section id="content">
        <div class="content-wrap">
            <div id="logo">
                <a href="{{url('/')}}" class="standard-logo" data-dark-logo="logo.png"><img src="{{url('website/logo.png')}}" alt="Allour Travel Logo"></a>
                <a href="{{url('/')}}" class="retina-logo" data-dark-logo="logo.png"><img src="{{url('website/logo.png')}}" alt="Allour Travel Logo"></a>
            </div>
            <div class="container clearfix">
